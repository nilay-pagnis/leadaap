...
export function DashboardShell({
  ...
  return (
    <div className="relative min-h-dvh overflow-x-hidden bg-[#F8FAFC] text-foreground">
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-40 flex h-dvh max-h-dvh w-[min(260px,85vw)] flex-col border-r border-slate-200/90 bg-white/90 pb-[env(safe-area-inset-bottom,0px)] shadow-[1px_0_0_rgba(15,23,42,0.04)] backdrop-blur-xl transition-transform duration-300 ease-out lg:w-[260px] lg:translate-x-0",
