...
export function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-[#F8FAFC] text-foreground">
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-40 flex h-screen w-[260px] flex-col border-r border-slate-200/90 bg-white/95 shadow-[1px_0_0_rgba(15,23,42,0.04)] backdrop-blur-xl transition-transform duration-300 ease-out lg:translate-x-0",
